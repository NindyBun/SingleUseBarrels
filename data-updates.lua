...
local technology_name = "SUB-fluid-handling"
-- The base empty barrel item
local empty_barrel_name = "SUB-empty-barrel"

-- Item icon masks
local barrel_side_mask = "__SingleUseBarrels__/graphics/barrel-side-mask.png"
local barrel_hoop_top_mask = "__SingleUseBarrels__/graphics/barrel-hoop-top-mask.png"

-- Recipe icon masks
local barrel_empty_icon = "__SingleUseBarrels__/graphics/barrel-empty.png"
local barrel_empty_side_mask = "__SingleUseBarrels__/graphics/barrel-empty-side-mask.png"
local barrel_empty_top_mask = "__SingleUseBarrels__/graphics/barrel-empty-top-mask.png"
local barrel_fill_icon = "__SingleUseBarrels__/graphics/barrel-fill.png"
local barrel_fill_side_mask = "__SingleUseBarrels__/graphics/barrel-fill-side-mask.png"
local barrel_fill_top_mask = "__SingleUseBarrels__/graphics/barrel-fill-top-mask.png"

-- Alpha used for barrel masks
local side_alpha = 0.75
local top_hoop_alpha = 0.75
-- Fluid required per barrel recipe
local fluid_per_barrel = settings.startup["SUB-fluid-amount"].value
...
local function get_recipes_for_barrel(name)
  ...
  if recipes then
    return recipes["SUB-fill-" .. name], recipes["SUB-empty-" .. name]
  end
  return nil
end
...
local function process_fluid(fluid, technology, empty_barrel_item)
  ...
  local barrel_name = fluid.name .. "-single-use-barrel"
